            	...
            	<?php
					...
					?>
                    	<div id="cuerpocenter_home">
                          <object id="FlashID2" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="585" height="474">
                            <param name="movie" value="img/cuerpo.swf" />
                            ...
                            <!--[if !IE]>-->
                            <object type="application/x-shockwave-flash" data="img/cuerpo.swf" width="585" height="474">
                              <!--<![endif]-->
                              <param name="quality" value="high" />
                              <param name="wmode" value="transparent" />
                              <param name="swfversion" value="6.0.65.0" />
